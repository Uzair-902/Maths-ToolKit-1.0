...
#LABEL
label = 'Math ToolKit 1.0'.center(50)
...
def divide():
	try:
		n = int(input('Enter Dividend Number:'))
		n2 = int(input('Enter Divisor Number:'))

		print(Fore.GREEN+ f'DIVSION: {n/n2}')
	except Exception:
		print(Fore.LIGHTRED_EX+'ERROR: Division by ZERO is NOT Allowed!')
...
while True:
	try:
		...
		print(Fore.RED+ f'AN ERROR ({e}) OCCURED. PLEASE MAKE SURE YOUR INPUT IS VALID.')
		break